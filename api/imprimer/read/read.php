                ...
                foreach($trouver as $find)
                    {
                        ...
                        echo '<td style=text-align:center;><a href="/wordpress/imprimante/?id=' . $find['id_imprimante'] . '">Modifier</a></td>';
            ...
            foreach($result as $imprimante){
                ...
                else
                {
                    echo "<tr>";
                        ...
                        echo "<td style=text-align:center;>" . $imprimante['imprimante_adresse_ip'] . "</td>";
                        echo "<td style=text-align:center;>" . $imprimante['id_prise_reseau'] . "</td>";
                        ...
                        echo '<td style=text-align:center;><a href="/wordpress/imprimante/?id=' . $imprimante['id_imprimante'] . '">Modifier</a></td>';
